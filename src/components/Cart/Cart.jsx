...
function Cart() {
  const {cart, cleanCart, deleteProductCart, totalPrice, totalItems} = useContext(CartContext);
  ...
  return (
    <div className='cart'>
      ...
      <h3>{`Subtotal (${totalItems()} items):`} <span className='total-price'>${totalPrice()}</span></h3>
